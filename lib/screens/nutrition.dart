                  ...
                  children: List.generate(6, (index) {
                    return Card(
                      ...
                      child: ListTile(
                        ...
                        leading: index % 2 == 0 ? Icon(Icons.fastfood, color: CupertinoTheme.of(context).primaryContrastingColor)
                            : Icon(Icons.local_drink, color: CupertinoTheme.of(context).primaryContrastingColor),
                        title: index % 2 == 0 ? Text('Meal')
                            : Text('Water Intake'),
                        subtitle: index % 2 == 0 ? Text('Calories: ${Random().nextInt(1000)}')
                      ...
                      child: CupertinoButton(
                        child: Row(
                          children: [
                            ...
                            Column(
                              children: [
                                Text('View All Meals', style: TextStyle(
